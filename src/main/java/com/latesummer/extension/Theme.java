...
import com.latesummer.domain.dto.Comment;
import com.latesummer.domain.dto.Types;
...
public final class Theme {
    ...
    *//**
    ...
    public static String permalink(Integer cid, String slug) {
        return Commons.site_url("/article/" + (StringUtil.isNotBlank(slug) ? slug : cid.toString()));
    }
    ...
    *//**
    ...
    public static List<String> category_list() {
        Contents contents = current_article();
        if (null != contents && StringUtil.isNotBlank(contents.getCategories())) {
    ...
    *//**
    ...
    public static List<String> tag_list() {
        Contents contents = current_article();
        if (null != contents && StringUtil.isNotBlank(contents.getTags())) {
    ...
    *//**
    ...
    public static String show_categories(String categories) throws UnsupportedEncodingException {
        if (StringUtil.isNotBlank(categories)) {
    ...
    *//**
    ...
    public static String show_tags(String split) throws UnsupportedEncodingException {
        Contents contents = current_article();
        if (StringUtil.isNotBlank(contents.getTags())) {
    ...
    *//**
    ...
    public static String show_thumb(Contents contents) {
        ...
        if (StringUtil.isNotBlank(contents.getThumbImg())) {
